...
/**
 * Strings for block_custom_links.
 *
...
$string['pluginname'] = 'Custom Links';
$string['privacy:metadata'] = 'The Custom Links block does not store any personal data.';
$string['iconlinksheader'] = 'Icons Links';
$string['textlinksheader'] = 'Text Links';
$string['addnewiconlink'] = '+ add more';
